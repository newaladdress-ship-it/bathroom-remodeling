...
export const metadata: Metadata = {title: {
    absolute: "Bathroom Remodel Support | Chandler AZ Bathroom Remodeling"
  },description: "Bathroom remodeling service in Chandler, AZ by ARZ. Explore bathroom remodel support, custom showers, tile, vanities, clear pricing, and free estimates.",
  robots: {
    index: true,
    follow: true,
  },
...
export default function RoofingPage() {
  return (
    <>
      ...
      <BreadcrumbSchema items={[ { name: "Home", url: "https://arzhomeremodeling.com/" }, { name: "Services", url: "https://arzhomeremodeling.com/services/" }, { name: "Roofing Chandler Az", url: "https://arzhomeremodeling.com/roofing-chandler-az/" } ]} />
<Header />
