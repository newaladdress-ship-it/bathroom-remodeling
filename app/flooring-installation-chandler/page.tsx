...
export default function FlooringPage() {
  return (
    <>
      ...
      <BreadcrumbSchema items={[ { name: "Home", url: "https://arzhomeremodeling.com/" }, { name: "Services", url: "https://arzhomeremodeling.com/services/" }, { name: "Flooring Installation Chandler", url: "https://arzhomeremodeling.com/flooring-installation-chandler/" } ]} />
<Header />
      <main className="min-h-[80vh] flex flex-col justify-center items-center py-24 bg-background">
        <div className="container mx-auto px-4 max-w-2xl text-center">
          ...
          <p className="text-muted-foreground text-lg leading-relaxed mb-8">
            ...
            We no longer offer general residential flooring or whole-house hardwood carpentry services outside of custom bathroom floors.
          </p>
